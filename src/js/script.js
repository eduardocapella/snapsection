jQuery(document).ready(function ($) {
	...
	headings.forEach(function (heading, i) {
		...
		let h3Wrapper = heading.querySelector('.cwss-h3-wrapper');
		let h3ContainerHeight = h3Wrapper.offsetHeight;
		...
		button.addEventListener('click', function () {
			...
			messageElement.classList.add('message-balloon');
